...
if __name__ == "__main__":
    ...
    print(f"Shape of keyword_pairs_table: {df.shape}")
    df.to_sql("keyword_pairs_table", engine, if_exists="replace", index=False)
    print("Successfully populated `keyword_pairs_table` in postgreSQL datastore")
    conn.close()
